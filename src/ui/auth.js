(function () {
  ...
  loginForm.addEventListener('submit', async (e) => {
    ...
    try {
      ...
      loginError.textContent = err.message.replace(/^Error invoking remote method[^:]*:\s*/, '').replace(/^Error:\s*/, '');
    }
  });
  ...
  registerForm.addEventListener('submit', async (e) => {
    ...
    try {
      ...
      registerError.textContent = err.message.replace(/^Error invoking remote method[^:]*:\s*/, '').replace(/^Error:\s*/, '');
    }
  });
